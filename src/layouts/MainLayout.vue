...
const rotinasLinks = [
  ...
  { title: 'Usuários', icon: 'person', caption: 'Cadastro de usuários', link: '/listusuarios' },
  ...
  { title: 'Agendamento de visita', icon: 'event', caption: 'Agendamento de visita', link: '/incvisita' }
